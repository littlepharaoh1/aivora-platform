...
export default function App() {
  const [config, setConfig] = useState<ProjectConfig>(() => JSON.parse(localStorage.getItem("aivoraProjectConfig") || "null") || defaultConfig);
useEffect(() => {
